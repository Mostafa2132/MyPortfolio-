...
export function LampDemo() {
  return (
    <LampContainer className="absolute inset-0 h-screen ">
      <h1>Hello</h1>
    </LampContainer>
  );
}
...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex items-center justify-center  w-full overflow-hidden rounded-md z-0",
        className
      )}
    >
      <div className="absolute flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        <motion.div
          ...
          className="absolute inset-auto right-1/2 h-full overflow-visible w-[30rem] bg-gradient-conic from-cyan-500 via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top]"
        >
